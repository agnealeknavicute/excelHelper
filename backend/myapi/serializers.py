...
class UpdatedIncomeSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        if income_items_data:
            ...
            for item in income_items_data:
                item.pop('type', None)
            income_objects = [Income.objects.create(type=item_type_value, **item) for item in income_items_data]
            ...
            for item in expense_items_data:
                item.pop('type', None)
            expense_objects = [Expense.objects.create(type=item_type_value, **item) for item in expense_items_data]
